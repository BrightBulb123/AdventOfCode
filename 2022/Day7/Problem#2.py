...
unused_space_target = 30_000_000
actual_unused = total_size - root.size
eliminate_need = unused_space_target - actual_unused

directories_that_meet_threshold = directory_crawler(root, eliminate_need)
print(min(directories_that_meet_threshold, key=lambda directory: directory.size).size)
