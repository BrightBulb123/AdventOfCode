...
class Hand:
    ...
    def distinction_evaluator(self) -> str:
        ...
        match len(self.cards_counter):
            ...
            case 2:
                if "J" in self.cards_counter:
                    return "Five of a kind"
                elif self.cards_counter.most_common(1)[0][-1] == 4:
            ...
            case 3:
                ...
                if len(set(most_common_2_counts)) == 1:
                    if self.cards_counter["J"] in most_common_2_counts:
                        return "Four of a kind"
                    elif self.cards_counter["J"] == 1:
                        return "Full house"
                    else:
                        return "Two pair"
            case 4:
                return "Three of a kind" if "J" in self.cards_counter else "One pair"
            case 5:
                return "One pair" if "J" in self.cards_counter else "High card"
            case _:
                raise IncorrectInputError(
